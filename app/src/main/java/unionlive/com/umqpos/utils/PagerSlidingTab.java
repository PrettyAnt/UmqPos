...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF0084FF ;//#0084FF
	...
	private int indicatorHeight = 2;//线的高度
	private int underlineHeight = 2;
	private int dividerPadding = 12;
	private int tabPadding = 24;
	private int dividerWidth = 1;//分割线的宽度

	private int tabTextSize = 17;//文字大小
		...
		public void onPageSelected(int position) {
			...
			for (int i = 0; i < tabCount; i++) {
				...
				if(v instanceof TextView){
					...
					textView.setTextColor(i==pager.getCurrentItem()?getResources().getColor(R.color.indicator_color):tabTextColor);
				}
			}
		}
	}
