 ...
 * @version 2016/12/8 17:25
 * @describe 商户退出登录 返回报文
 */

public class ExitLoginResponse {

    /**
     * header : {"version":"1.0","transType":"T108","submitTime":"20161208172233","sessionId":"","clientTraceNo":"","hostTime":"20161208172248","hostTraceNo":"324673","returnCode":"9999","returnMessage":"系统错误"}
     * body : {}
     */
    ...
    public ExitLoginResponse(HeaderBean header, BodyBean body) {
        this.header = header;
        this.body = body;
    }
