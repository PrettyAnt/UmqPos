...
public class ReportException {
    ...
    /**
     * header : {"version":"1.0","transType":"M003","submitTime":"20161208134318","sessionId":"","clientTraceNo":"089f54c7-f013-4b51-8acc-2a1ae05e730a","method":"unionlive.system.reportexception"}
     * body : {"appId":"182000899000001","appVersionNo":"1","appVersion":"1.0","deviceType":"clientz","deviceOS":"clientz","deviceOSVersion":"44","deviceModel":"clientz","bugDesc":"APP出错了，记录到日志文件。"}
     */

    public HeaderBean header;
    public BodyBean   body;

    public ReportException(HeaderBean header, BodyBean body) {
        this.header = header;
        this.body = body;
    }
    ...
    public static class HeaderBean {
         ...
         * method : unionlive.system.reportexception
         */
    ...
    public static class BodyBean {
        public BodyBean(String appId, int appVersionNo, String appVersion,
                        ...
                        String city, String street0, String street1, String street2, String mmc,
                        String mnc, String lac, String cellID, String apMAC,
                        String apSSID, String bugDesc) {
            this.appId = appId;
