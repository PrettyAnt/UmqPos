 ...
 * @version 2016/12/8 19:18
 * @describe 取消订单的返回报文
 */

public class OrderCancelResponse {
    /**
     * header : {"version":"1.0","transType":"T302","submitTime":"20161208190549","sessionId":"","clientTraceNo":"","hostTime":"20161208190600","hostTraceNo":"326053","returnCode":"6011","returnMessage":"orderId 参数不能为空"}
     * body : {}
     */
    ...
    public OrderCancelResponse(HeaderBean header, BodyBean body) {
        this.header = header;
        this.body = body;
    }
    ...
    public static class HeaderBean {
         ...
         * sessionId :
         * clientTraceNo :
         * hostTime : 20161208190600
         * hostTraceNo : 326053
         * returnCode : 6011
         * returnMessage : orderId 参数不能为空
         */
