 ...
 * @version 2016/12/8 19:47
 * @describe 同步更新百度门店返回报文
 */

public class SyncBaiduResponse {
    /**
     * header : {"version":"1.0","transType":"T305","submitTime":"20161208194122","sessionId":"","clientTraceNo":"","hostTime":"20161208194148","hostTraceNo":"326317","returnCode":"0000","returnMessage":"交易成功"}
     * body : {}
     */
    ...
    public SyncBaiduResponse(HeaderBean header, BodyBean body) {
        this.header = header;
        this.body = body;
    }
