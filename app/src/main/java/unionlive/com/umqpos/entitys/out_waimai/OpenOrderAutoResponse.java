 ...
 * @version 2016/12/8 19:28
 * @describe 开启制定渠道自动接单返回报文
 */

public class OpenOrderAutoResponse {
    /**
    ...
    public OpenOrderAutoResponse(HeaderBean header, BodyBean body) {
        this.header = header;
        this.body = body;
    }
    ...
    public static class HeaderBean {
        ...
        public HeaderBean(String version, String transType,
                          String submitTime, String sessionId, String clientTraceNo,
