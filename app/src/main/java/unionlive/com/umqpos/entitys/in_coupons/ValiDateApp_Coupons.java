 ...
 * @describe 客户端应用校验_验券的接口_进入app前的客户端校验，本来使用外卖的接口，
 */

public class ValiDateApp_Coupons {
    public HeaderBean header;
    public BodyBean body;

    public ValiDateApp_Coupons(HeaderBean header, BodyBean body) {
        this.header = header;
        this.body = body;
    }
    ...
    public static class BodyBean {
        ...
        public BodyBean(String appId,
                        int appVersionNo, String appVersion,
                        String deviceId, String deviceType,
                        String deviceOS, String deviceOSVersion,
                        String deviceModel, String browserType,
                        String browserVersion, String clientMAC,
                        String longitude, String latitude, String country,
                        String countryCode, String region, String city, String street0, String street1, String street2,
